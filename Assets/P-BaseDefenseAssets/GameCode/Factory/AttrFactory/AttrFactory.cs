...
public class AttrFactory : IAttrFactory
{
    ...
    private void InitAdditionalAttr()
    {
        ...
        //字首产生时随机产生
        m_AdditionAttrDB.Add(11, new AdditionalAttr(3, 0, "勇士"));
        m_AdditionAttrDB.Add(12, new AdditionalAttr(5, 0, "猛将"));
        m_AdditionAttrDB.Add(13, new AdditionalAttr(10, 0, "英雄"));

        // 字尾存活下来即增加
        m_AdditionAttrDB.Add(21, new AdditionalAttr(5, 1, "◇"));
        m_AdditionAttrDB.Add(21, new AdditionalAttr(5, 1, "☆"));
        m_AdditionAttrDB.Add(21, new AdditionalAttr(5, 1, "★"));
    }
    //取得加成用的数值
    ...
    public override WeaponAttr GetWeaponAttr(int AttID)
    {
        ...
        {
            Debug.LogWarning("GetWeaponAttr:AttrID[" + AttID + "]数值不存在");
        }
        //直接回传共用的武器数值
